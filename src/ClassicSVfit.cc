...
void ClassicSVfit::setLegIntegrationParams(unsigned iLeg, bool useMassConstraint)
{
...
void ClassicSVfit::setIntegrationRanges(unsigned iLeg)
{
...
void ClassicSVfit::clearMET()
{ 
  integrand_->clearMET();
}

void ClassicSVfit::addMETEstimate(double measuredMETx, double measuredMETy, const TMatrixD& covMET)
{
			     ...
			     const TMatrixD& covMET)
{
  ...
  intAlgo_->integrate(&g_C, xl_, xu_, numDimensions_, theIntegral_, theIntegralErr_);
